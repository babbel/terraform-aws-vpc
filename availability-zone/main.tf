...
resource "aws_route_table" "public" {
  ...
  tags = merge({ Name = "${var.vpc.tags.Name} ${local.availability_zone} public" }, var.tags)
}
...
resource "aws_eip" "this" {
  ...
  tags = merge({ Name = "${var.vpc.tags.Name} ${local.availability_zone}" }, var.tags)
}
...
resource "aws_route_table" "private" {
  ...
  tags = merge({ Name = "${var.vpc.tags.Name} ${local.availability_zone} private" }, var.tags)
}
